    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item {{ Request::path() === '/' ? 'active' : '' }}"><a href="{{ route('main') }}" class="nav-link">Home</a></li>
                <li class="nav-item {{ Request::path() === 'menu' ? 'active' : '' }}"><a href="{{ route('menu') }}" class="nav-link">Menu</a></li>
                @guest
                    <li class="nav-item">
