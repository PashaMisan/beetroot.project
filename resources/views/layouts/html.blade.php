    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item {{ Request::path() === '/' ? 'active' : '' }}"><a href="{{ route('main') }}"
                                                                                      class="nav-link">Home</a></li>
                <li class="nav-item {{ Request::path() === 'menu' ? 'active' : '' }}"><a href="{{ route('menu') }}"
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            <a class="dropdown-item" href="{{ route('admin_panel_main') }}">Admin panel</a>
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            ...
                            <div class="meta">
                                ...
                                <div><a><span class="icon-chat"></span> Comment count</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="block-21 mb-4 d-flex">
            ...
            <div class="col-lg-2 col-md-6 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4 ml-md-4">
                    ...
                    <ul class="list-unstyled">
                        <li><span class="py-2 d-block">Cooked</span></li>
                        <li><span class="py-2 d-block">Deliver</span></li>
                        <li><span class="py-2 d-block">Quality Foods</span></li>
                        <li><span class="py-2 d-block">Mixed</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a><span class="icon icon-envelope"></span><span class="text">info@yourdomain.com</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
