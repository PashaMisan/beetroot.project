                                    ...
                                    <div class="list-group">
                                        <a href="#" class="list-group-item list-group-item-action active">
                                            <div class="notification-info">
                                                <div class="notification-list-user-img"><img src="{{ asset('admin_panel/assets/images/avatar-2.jpg') }}" alt="" class="user-avatar-md rounded-circle"></div>
                   ...
                   {{-- <li class="nav-item dropdown connection">
                    ...
                    <li class="nav-item dropdown nav-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                            ...
                            <a class="dropdown-item" href="{{ route('home') }}"><i class="fas fa-external-link-square-alt mr-2"></i>Exit</a>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="{{ route('admin_panel_main') }}" {{--data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"--}}><i class="fa fa-fw fa-user-circle"></i>Dashboard <span class="badge badge-success">6</span></a>
